...
<head>
    ...
    <title>Modify product type</title>
...
<div class="container">
    ...
    <form:form method="POST" action="/productTypeModify" modelAttribute="productTypeForm"
               name="productTypeForm" enctype="multipart/form-data">
        <h3 class="form-heading">Modify product type</h3>
        <div>
            <table>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="categories" class="col2input" value="${category}"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="price" class="col2input" value="${productType.price}"
                               pattern="\d+(.\d{1}|{2})?"></td>
                </tr>
                <tr>
            ...
            <table id="myTable">
                ...
                <c:forEach items="${productType.attributes}" var="attribute" varStatus="status">
                    <tr>
                        ...
                        <td><input type="text" name="values" value="${productType.values[status.index].value}"></td>
                    </tr>
                    <%--productType.values[size - status.index - 1].value--%>
                </c:forEach>
            </table>
